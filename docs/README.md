...
- [`specs/2026-09-14-json-projection-design.md`](specs/2026-09-14-json-projection-design.md), the versioned machine-readable read contract (`render --json` and `show --json`; deterministic live projection, complete event records, folded lifecycle).
