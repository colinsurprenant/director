...
- [`specs/2026-09-11-peer-chat-design.md`](specs/2026-09-11-peer-chat-design.md), the Parley design (peer chat: models collaborating over a chat stream one layer above the ledger; stream-with-cursor primitive, per-harness native delivery, the promotion protocol; sibling project `parley`, built through M7 and scored; Amendments section of 2026-09-23 indexes the Parley log).
