...
record() {
  ...
  # and harnesses DO fire the same event concurrently (parallel hooks,
  # subagents) — two firings would land on the same n and clobber a payload.
  # The PID makes the name unique per firing; n keeps rough arrival order.
