...
- `payload.chat.message.3.json`: input, messageID
- `payload.chat.message.injected.1.json`: token
- `payload.chat.message.injected.2.json`: token
- `payload.event.catalog.updated.1.json`: (unparsed)
- `payload.event.catalog.updated.2.json`: (unparsed)
- `payload.event.catalog.updated.3.json`: (unparsed)
- `payload.event.catalog.updated.4.json`: (unparsed)
- `payload.event.integration.updated.1.json`: (unparsed)
- `payload.event.integration.updated.2.json`: (unparsed)
...
- `payload.event.reference.updated.1.json`: (unparsed)
- `payload.event.reference.updated.2.json`: (unparsed)
...
```
cd /var/folders/0v/vw52k5gd7t9bk0v2lyj5dg780000gn/T//canary-opencode-ws.0AtBeS
